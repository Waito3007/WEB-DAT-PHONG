        ...
        {user ? (
          <div className="user-avatar cursor-pointer" onClick={toggleMenu}>
            <img
              src={
                user.avatar ||
                "https://res-console.cloudinary.com/dackig67m/thumbnails/v1/image/upload/v1728362097/aG90ZWxzL2ZpbGVfbXk5c2l1/drilldown"
              }
              alt="Avatar"
          ...
          <>
            <button
              className="login-btn bg-gray-300 border-2 border-black py-2 px-4 text-black text-lg mr-2"
              onClick={handleLogin}
            >
              Đăng nhập
            </button>
            <button
              className="signup-btn bg-gray-300 border-2 border-black py-2 px-4 text-black text-lg"
