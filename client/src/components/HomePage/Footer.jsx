          ...
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  <li className="mb-4">
                    <a href="https://github.com/YouAreMyHome" className="hover:underline">
                      Github
                    </a>
                  </li>
                  <li>
                    <a href="https://discord.gg/j6bZTk9snN" className="hover:underline">
                      Discord
                    </a>
                  </li>
                </ul>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © 2024 <Link onClick={() => {
                    ...
                    className="hover:underline">StayNight™</Link>. All Rights Reserved.
            </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              <a href="https://www.facebook.com/consauchetduoi" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                  <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                        <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                    </svg>
                  <span class="sr-only">Facebook page</span>
              </a>
              <a href="https://discord.gg/j6bZTk9snN" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
              ...
              <a href="https://github.com/YouAreMyHome" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
